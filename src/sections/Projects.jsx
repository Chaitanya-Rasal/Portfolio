        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          {projects.map((project) => (
            <motion.div 
              ...
              whileHover={{ y: -12 }}
              className="group relative glass-card rounded-3xl overflow-hidden flex flex-col h-full shadow-lg hover:shadow-2xl transition-all duration-500 border border-white/10"
            >
              ...
              <div className="p-8 flex flex-col flex-grow bg-white/50 dark:bg-dark-card/30 backdrop-blur-sm">
